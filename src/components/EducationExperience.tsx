...
const EducationExperience: React.FC = () => {
  return (
    <section id="experience" className="py-15 bg-serene-900/50 relative">
          ...
          <div>
            ...
            <div className="space-y-8">
              {EXPERIENCE.map((exp, index) => (
                <div
                  key={index}
                  className="relative pl-8 border-l border-serene-800"
                >
                  ...
                  <div className="glass-panel p-6 rounded-xl hover:border-serene-500/30 transition-colors">
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-2">
                      <h3 className="text-xl font-bold text-serene-100">
                        {exp.role}
                      </h3>
                    ...
                    <h4 className="text-lg text-serene-300 mb-4">
                      {exp.company}
                    </h4>
              ...
              {EDUCATION.map((edu, index) => (
                ...
                >
                  ...
                  <div className="glass-panel p-6 rounded-xl hover:border-accent-gold/30 transition-colors">
                    ...
                    <h4 className="text-lg text-accent-gold mb-4">
                      {edu.degree}
                    </h4>
                    <ul className="space-y-2">
